...
export declare abstract class ColumnAccessor {
     ...
     */
    readonly abstract field: SPField;
    /**
     * Whether to show this column in the list view.
     * This property is read-only.
     */
    readonly abstract visible: boolean;
}
/**
 ...
 * @public
 */
export declare class SelectedRowsChangedEventArgs extends EventArgs {
    /**
...
declare abstract class ListViewAccessor {
    /**
     * Event name when the selected rows in a list have changed.
     * @internal
     */
     ...
     */
    readonly abstract columns: ReadonlyArray<ColumnAccessor>;
    /**
     ...
     */
    readonly selectedRowsChangedEvent: Event<SelectedRowsChangedEventArgs>;
}

...
var ListView = (function (_super) {
    ...
    ListView.prototype._flattenItem = function (item) {
        ...
        if (!flatItem.key) {
            ...
            if (!flatItem.key) {
                flatItem.key = sp_core_library_1.Guid.newGuid().toString();
            }
        }
        return flatItem;
    };
    ...
    ListView.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            showFilter && React.createElement(SearchBox_1.SearchBox, { placeholder: filterPlaceHolder || strings.ListViewFilterLabel, onSearch: this._updateFilterValue, onChange: this._updateFilterValue, value: filterValue }),
            React.createElement(DetailsList_1.DetailsList, { key: "ListViewControl", items: items, columns: this.state.columns, groups: this.state.groups, selectionMode: this.props.selectionMode || DetailsList_1.SelectionMode.none, selectionPreservedOnEmptyClick: true, selection: this._selection, layoutMode: DetailsList_1.DetailsListLayoutMode.justified, compact: this.props.compact, setKey: "ListViewControl", groupProps: groupProps })));
    };
    return ListView;
}(React.Component));
